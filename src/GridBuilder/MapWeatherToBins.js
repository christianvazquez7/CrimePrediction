...
var csvStream = csv.createWriteStream({headers: true}), writableStream = fs.createWriteStream("../../data/RobberyNYC-Mapped.csv");
...
client.connect(NoSQLconnection, function (err, db) {
		...
		csv.fromPath("../../data/RobberyBins-Daily-Hours.csv")
