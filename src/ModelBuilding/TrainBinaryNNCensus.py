...
def baseline_model():
	# create model
	model = Sequential()
	model.add(Dense(25, input_dim=110, init='normal', activation='relu'))
...
filename = "../../data/Quarter/census/nyc-encoded-2006.csv"
zeroes = "../../data//Quarter/census/nyc-zero-encoded-2006.csv"
dataset = np.loadtxt(fname = filename, delimiter = ',')
dataset2 = np.loadtxt(fname = zeroes, delimiter = ',')

filename3 = "../../data/Quarter/census/nyc-encoded-2007.csv"
zeroes3 = "../../data/Quarter/census/nyc-zero-encoded-2007.csv"
...
validationFileName = "../../data/Quarter/census/nyc-encoded-2009.csv"
zeroValidation = "../../data/Quarter/census/nyc-zero-encoded-2009.csv"
